<div class="hide-menu">
    ...
    <ul class="menu-explore">
        ...
        <a href="{{ url('/events') }}">
        	<li class="{{ request()->is('events') ? 'active' : '' }}"><i class="fa fa-map-marker" style="color: #abc554;"></i>Acara <span class="badge" style="float: right;background-color: #abc554;">{{$data->count()}}</span></li>
        </a>
