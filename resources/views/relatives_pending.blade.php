                            ...
                            <div class="front">
                                ...
                                <div class="content">
                                    ...
                                    <div class="bottom" id="approve-buttons-{{ $relation->id }}">
                                        ...
                                        <a href="javascript:;" class="btn btn-success approve-button btn-sm" onclick="relativeRequest(1, {{ $relation->id }})"><i class="fa fa-check"></i> Setuju</a>
                                        <a href="javascript:;" class="btn btn-danger approve-button btn-sm" onclick="relativeRequest(2, {{ $relation->id }})"><i class="fa fa-times"></i> Tidak Sejuju</a>
                                    </div>
                                </div>
                            </div>
                        </div>
