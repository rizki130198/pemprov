...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
                <div class="panel-heading">Delete Akun</div>

                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/delete/akun/'.Auth::user()->id) }}">
                        {{ csrf_field() }}
                        <p><strong>Jika anda delete akun anda data anda akan hilang seluruhnya</strong></p>
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    Delete
