        ...
        <div class="col-md-9 col-md-offset-3 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 style="margin:0;">Upload File <small style="color: red;">* .doc, .docs, .psd, .xls, .xlsx, .jpg, .jpeg, .png, .pdf, .rar, .zip</small></h3>
                    <hr>
                    <label>File</label>
            ...
            <h3 style="margin:0;">Files <small>(20)</small></h3>
            <p style="width: 100%;border-bottom: dashed 2px #d1d1d1;padding-top: 15px;"></p>
            <div class="row">
                <a href="#">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_xls">.xls</div></center>
                        <p align="center" style="color: #555;">testasd asdasd</p>
                    </div>
                </a>
                <a href="#">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_xlsx">.xlsx</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_doc">.doc</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_docx">.docx</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_psd">.psd</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_jpg">.jpg</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_jpeg">.jpeg</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_pdf">.pdf</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_png">.png</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_rar">.rar</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
                <a href="">
                    <div class="col-md-2 col-xs-4"> 
                        <center><div class="icon icon_type_file icon_ext_zip">.zip</div></center>
                        <p align="center" style="color: #555;">testasd</p>
                    </div>
                </a>
            </div>      
